package com.carshop.app.infrastructure.authentication.services;

import java.util.List;
import java.util.stream.Collectors;

import com.carshop.app.infrastructure.authentication.enums.ClaimEnum;
...
public class JWTCreator {
    ...
    public static JWTObject create(String token, String prefix, String key) throws ExpiredJwtException, UnsupportedJwtException, MalformedJwtException {
        ...
        object.setUserId(convertToLong((Integer) claims.get(ClaimEnum.USER_ID.getKey())));
        object.setCustomerId(convertToLong((Integer) claims.get(ClaimEnum.CUSTOMER_ID.getKey())));
        return object;
    }
    ...
    private static Long convertToLong(final Integer value) {
