...
import com.carshop.app.modules.models.services.impl.ModelServiceImpl;
...
public class ModelServiceTestImpl {
    ...
    public void shouldSaveNewModel() throws Exception {
        ...
        final Model insertedModel = this.modelService.save(model);
    ...
    public void shouldUpdateModel() throws Exception {
        ...
        final Model updatedModel = this.modelService.save(model);
    ...
    public void shouldListModels() throws Exception {
        ...
        final List<Model> fetchedModels = this.modelService.findAllByCustomerId(customerId);
    ...
    public void shouldGetModel() throws Exception {
        ...
        final Model fetchedModel = this.modelService.findByCustomerIdAndModelId(customerId, model.getId());
    ...
    private Model mountInsertedModel(final Model model) {
        model.setId(1);
        return model;
    }
